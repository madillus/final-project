...
return (
  <Layout>
    <FirstSection>
    <FirstSectionText>
      <CardText>The Brewery</CardText>
        <CardText>All beer starts its life as crops on a field the grains are harvested and prepaired for brewing in a process called malting. 1516 Brewing Company basically brews ales and beers from malted barley but also uses malted and unmalted wheat, rye and rice when the receipe calls for these. Caramelized malts, roasted malts and even smoked malts in the grain bill give the beers specific aromas, a robust body and a distinctive colour.< br/>< br/>Production in the brewery starts with the milling of the malt to produce the grist which goes into the brew kettle together with the liquor that is what a brewer calls the water used in brewing. This first part of the actual brewing process that takes place in the two copper-coated vessels behind the bar is called mashing. Natural enzymes in the malt break down the starch into sugars. After this step is completed the mash is pumped to the lautertun, where the spent grains are held back and a clear liquid called the wort runs off to the brew kettle: It contains the sugars and the other aromas of the malt and is now toroughly boiled.< br/>< br/> During the boil hops are added. Hops are the cone-shaped blossoms of the female hop plant.After the boil is finished the hot wort is cooled down and yeast is added to ferment the sugar to alcohol and CO2. The strain of yeast used as well as the fermentation temperature determine if the finished product is a cold fermented lager or an ale which is fermented at room temperature. Enjoy! < br/>< br/>Bierpapst Conrad Seidl</CardText>
