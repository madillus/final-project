                ...
                {props.seasonal.map((seasonal) => {
                  return (
                    <StyledGrid key={seasonal.id}>
                      <StyledItem>
                        {seasonal.name}| {seasonal.german_name}{' '}
                      </StyledItem>
                      <StyledItem> </StyledItem>
                ...
                {props.classics.map((classics) => {
                  return (
                    <StyledGrid key={classics.id}>
                      <StyledItem>
                        {classics.name}| {classics.german_name}{' '}
                      </StyledItem>
                      <StyledItem> </StyledItem>
                ...
                {props.sandwiches.map((sandwiches) => {
                  return (
                    <StyledGrid key={sandwiches.id}>
                      <StyledItem>
                        {sandwiches.name}| {sandwiches.german_name}{' '}
                      </StyledItem>
                      <StyledItem> </StyledItem>
                ...
                {props.salads.map((salads) => {
                  return (
                    <StyledGrid key={salads.id}>
                      <StyledItem>
                        {salads.name}| {salads.german_name}{' '}
                      </StyledItem>
                      <StyledItem> </StyledItem>
                ...
                {props.sausages.map((sausages) => {
                  return (
                    <StyledGrid key={sausages.id}>
                      <StyledItem>
                        {sausages.name}| {sausages.german_name}{' '}
                      </StyledItem>
                      <StyledItem> </StyledItem>
                ...
                {props.snacks.map((snacks) => {
                  return (
                    <StyledGrid key={snacks.id}>
                      <StyledItem>
                        {snacks.name}| {snacks.german_name}{' '}
                      </StyledItem>
                      <StyledItem> </StyledItem>
                ...
                {props.desserts.map((desserts) => {
                  return (
                    <StyledGrid key={desserts.id}>
                      <StyledItem>
                        {desserts.name}| {desserts.german_name}{' '}
                      </StyledItem>
                      <StyledItem> </StyledItem>
